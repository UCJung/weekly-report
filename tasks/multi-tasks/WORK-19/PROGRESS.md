...
| WORK-19-TASK-07 | Backend 빌드 아티팩트 불일치 500 에러 수정 | — | Done | 773c1ca | clean 빌드로 해결, 코드변경 없음 |
| WORK-19-TASK-08 | 프로젝트투입현황 행선택·승인완료 색상 중복 수정 | TASK-06 | Done | 79bde19 | 오류수정 |
| WORK-19-TASK-09 | 승인된 프로젝트 월간승인 버튼 → 승인완료 텍스트 변경 | TASK-06 | Done | 8524328 | 기능수정 |
| WORK-19-TASK-10 | 관리자 근무시간표 관리 팀단위 표시 개선 | — | Done | — | 기능개선 |
...
- TASK-08: 프로젝트투입현황 행선택·승인완료 Badge 색상 중복 — 승인완료를 보라색(--primary-bg/--primary)으로 변경
- TASK-09: 승인된 프로젝트의 월간승인 버튼을 보라색 "승인완료" 텍스트+아이콘으로 조건부 렌더링
- TASK-10: 관리자 근무시간표 관리 — 요약카드(전체팀/팀장승인완료/전체프로젝트/PM승인완료) + 테이블 팀단위(승인인원/전체인원, 완료/진행중)
