...
| WORK-18-TASK-13 | 횡스크롤 고정열(sticky left) + 알림/목록 너비 통일 | TASK-12 | Done | e240500 | |
...
| WORK-18-TASK-22 | 프로젝트 투입현황 — 목록 테이블 + 행 선택 UX | TASK-21 | Done | — | |
| WORK-18-TASK-23 | 관리자 화면 레이아웃 통일 (툴바 카드 패턴) | TASK-22 | Done | — | |
...
- [2026-03-04] WORK-18-TASK-14 완료: 알림/목록 px-6 패딩 제거 → 헤더와 동일 전체 폭으로 확장
- [2026-03-04] WORK-18-TASK-15 완료: 행 배경색 상태별 분기(검증통과 녹색/실패 붉은색/불필요 회색), 시간 입력 셀 진한 강조
- [2026-03-04] WORK-18-TASK-16 완료: 공휴일/연차 제출 오류 수정 — 프론트 workLogs 초기화 + 백엔드 방어적 삭제
